...
describe('approval process table helpers', () => {
  ...
  describe('<MoveButtons />', () => {
    ...
    beforeEach(() => {
      ...
      helpers.updateWorkflow = jest
        .fn()
        .mockImplementation(() => Promise.resolve({ wf: 'ok' }));
      helpers.repositionWorkflow = jest
        .fn()
        .mockImplementation(() => Promise.resolve({ wf: 'ok' }));
      actions.fetchWorkflows = jest
        .fn()
        .mockImplementation(() => ({ type: 'fetch' }));
    });
