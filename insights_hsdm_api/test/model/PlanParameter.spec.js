...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceCatalogApi.PlanParameter();
  });
  ...
  describe('PlanParameter', function() {
    it('should create an instance of PlanParameter', function() {
      ...
      //var instane = new InsightsServiceCatalogApi.PlanParameter();
      //expect(instance).to.be.a(InsightsServiceCatalogApi.PlanParameter);
    });
