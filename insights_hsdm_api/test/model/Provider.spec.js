...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceCatalogApi.Provider();
  });
  ...
  describe('Provider', function() {
    it('should create an instance of Provider', function() {
      ...
      //var instane = new InsightsServiceCatalogApi.Provider();
      //expect(instance).to.be.a(InsightsServiceCatalogApi.Provider);
    });
