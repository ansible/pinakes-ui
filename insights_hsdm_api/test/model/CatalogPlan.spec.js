...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceCatalogApi.CatalogPlan();
  });
  ...
  describe('CatalogPlan', function() {
    it('should create an instance of CatalogPlan', function() {
      // uncomment below and update the code to test CatalogPlan
      //var instane = new InsightsServiceCatalogApi.CatalogPlan();
      //expect(instance).to.be.a(InsightsServiceCatalogApi.CatalogPlan);
    });
