...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TopologicalInventory.ServiceParametersSet();
  });
  ...
  describe('ServiceParametersSet', function() {
    it('should create an instance of ServiceParametersSet', function() {
      // uncomment below and update the code to test ServiceParametersSet
      //var instane = new TopologicalInventory.ServiceParametersSet();
      //expect(instance).to.be.a(TopologicalInventory.ServiceParametersSet);
    });
